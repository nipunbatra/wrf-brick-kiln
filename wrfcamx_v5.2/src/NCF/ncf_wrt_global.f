      subroutine ncf_wrt_global(action,iounit,l2dsrf,l2dmet,ncf_name,nvars,
     &                          varname)
      implicit none
c
...
c           nvars     I  number of species in file
c           varname   C  name of each variable
c       Outputs:
c
