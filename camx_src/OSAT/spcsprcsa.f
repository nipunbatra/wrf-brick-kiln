...
c
          ...
          numyld(ITRAG2) = 10
          nameyld(ITRAG2,1) = 'BENZ'
          yieldH(ITRAG2,1) = MAX(EPSYLD, y_h(1,1))
          yieldL(ITRAG2,1) = MAX(EPSYLD, y_l(1,1))
          nameyld(ITRAG2,2) = 'TOLU'
          yieldH(ITRAG2,2) = MAX(EPSYLD, y_h(1,2))
          yieldL(ITRAG2,2) = MAX(EPSYLD, y_l(1,2))
          nameyld(ITRAG2,3) = 'ARO1'
          yieldH(ITRAG2,3) = MAX(EPSYLD, y_h(1,2))
          yieldL(ITRAG2,3) = MAX(EPSYLD, y_l(1,2))
          nameyld(ITRAG2,4) = 'OXYL'
          yieldH(ITRAG2,4) = MAX(EPSYLD, y_h(1,3))
          yieldL(ITRAG2,4) = MAX(EPSYLD, y_l(1,3))
          nameyld(ITRAG2,5) = 'MXYL'
          yieldH(ITRAG2,5) = MAX(EPSYLD, y_h(1,3))
          yieldL(ITRAG2,5) = MAX(EPSYLD, y_l(1,3))
          nameyld(ITRAG2,6) = 'PXYL'
          yieldH(ITRAG2,6) = MAX(EPSYLD, y_h(1,3))
          yieldL(ITRAG2,6) = MAX(EPSYLD, y_l(1,3))
          nameyld(ITRAG2,7) = 'B124'
          yieldH(ITRAG2,7) = MAX(EPSYLD, y_h(1,3))
          yieldL(ITRAG2,7) = MAX(EPSYLD, y_l(1,3))
          nameyld(ITRAG2,8) = 'ARO2'
          yieldH(ITRAG2,8) = MAX(EPSYLD, y_h(1,3))
          yieldL(ITRAG2,8) = MAX(EPSYLD, y_l(1,3))
          nameyld(ITRAG2,9) = 'IVOA'
          yieldH(ITRAG2,9) = MAX(EPSYLD, y_h(1,4))
          yieldL(ITRAG2,9) = MAX(EPSYLD, y_l(1,4))
          nameyld(ITRAG2,10) = 'SVOA'
          yieldH(ITRAG2,10) = MAX(EPSYLD, y_h(1,5))
          yieldL(ITRAG2,10) = MAX(EPSYLD, y_l(1,5))
c
c  ---- AG1 species ---
c
          numcls(ITRAG1) = 1
          ...
          numyld(ITRAG1) = 10
          nameyld(ITRAG1,1) = 'BENZ'
          yieldH(ITRAG1,1) = MAX(EPSYLD, y_h(2,1))
          yieldL(ITRAG1,1) = MAX(EPSYLD, y_l(2,1))
          nameyld(ITRAG1,2) = 'TOLU'
          yieldH(ITRAG1,2) = MAX(EPSYLD, y_h(2,2))
          yieldL(ITRAG1,2) = MAX(EPSYLD, y_l(2,2))
          nameyld(ITRAG1,3) = 'ARO1'
          yieldH(ITRAG1,3) = MAX(EPSYLD, y_h(2,2))
          yieldL(ITRAG1,3) = MAX(EPSYLD, y_l(2,2))
          nameyld(ITRAG1,4) = 'OXYL'
          yieldH(ITRAG1,4) = MAX(EPSYLD, y_h(2,3))
          yieldL(ITRAG1,4) = MAX(EPSYLD, y_l(2,3))
          nameyld(ITRAG1,5) = 'MXYL'
          yieldH(ITRAG1,5) = MAX(EPSYLD, y_h(2,3))
          yieldL(ITRAG1,5) = MAX(EPSYLD, y_l(2,3))
          nameyld(ITRAG1,6) = 'PXYL'
          yieldH(ITRAG1,6) = MAX(EPSYLD, y_h(2,3))
          yieldL(ITRAG1,6) = MAX(EPSYLD, y_l(2,3))
          nameyld(ITRAG1,7) = 'B124'
          yieldH(ITRAG1,7) = MAX(EPSYLD, y_h(2,3))
          yieldL(ITRAG1,7) = MAX(EPSYLD, y_l(2,3))
          nameyld(ITRAG1,8) = 'ARO2'
          yieldH(ITRAG1,8) = MAX(EPSYLD, y_h(2,3))
          yieldL(ITRAG1,8) = MAX(EPSYLD, y_l(2,3))
          nameyld(ITRAG1,9) = 'IVOA'
          yieldH(ITRAG1,9) = MAX(EPSYLD, y_h(2,4))
          yieldL(ITRAG1,9) = MAX(EPSYLD, y_l(2,4))
          nameyld(ITRAG1,10) = 'SVOA'
          yieldH(ITRAG1,10) = MAX(EPSYLD, y_h(2,5))
          yieldL(ITRAG1,10) = MAX(EPSYLD, y_l(2,5))
c
c  ---- BG2 species ---
c
          numcls(ITRBG2) = 1
...
c
          ...
          numyld(ITRPA0) = 10
          nameyld(ITRPA0,1) = 'BENZ'
          yieldH(ITRPA0,1) = MAX(EPSYLD, y_h(3,1))
          yieldL(ITRPA0,1) = MAX(EPSYLD, y_l(3,1))
          nameyld(ITRPA0,2) = 'TOLU'
          yieldH(ITRPA0,2) = MAX(EPSYLD, y_h(3,2))
          yieldL(ITRPA0,2) = MAX(EPSYLD, y_l(3,2))
          nameyld(ITRPA0,3) = 'ARO1'
          yieldH(ITRPA0,3) = MAX(EPSYLD, y_h(3,2))
          yieldL(ITRPA0,3) = MAX(EPSYLD, y_l(3,2))
          nameyld(ITRPA0,4) = 'OXYL'
          yieldH(ITRPA0,4) = MAX(EPSYLD, y_h(3,3))
          yieldL(ITRPA0,4) = MAX(EPSYLD, y_l(3,3))
          nameyld(ITRPA0,5) = 'MXYL'
          yieldH(ITRPA0,5) = MAX(EPSYLD, y_h(3,3))
          yieldL(ITRPA0,5) = MAX(EPSYLD, y_l(3,3))
          nameyld(ITRPA0,6) = 'PXYL'
          yieldH(ITRPA0,6) = MAX(EPSYLD, y_h(3,3))
          yieldL(ITRPA0,6) = MAX(EPSYLD, y_l(3,3))
          nameyld(ITRPA0,7) = 'B124'
          yieldH(ITRPA0,7) = MAX(EPSYLD, y_h(3,3))
          yieldL(ITRPA0,7) = MAX(EPSYLD, y_l(3,3))
          nameyld(ITRPA0,8) = 'ARO2'
          yieldH(ITRPA0,8) = MAX(EPSYLD, y_h(3,3))
          yieldL(ITRPA0,8) = MAX(EPSYLD, y_l(3,3))
          nameyld(ITRPA0,9) = 'IVOA'
          yieldH(ITRPA0,9) = MAX(EPSYLD, y_h(3,4))
          yieldL(ITRPA0,9) = MAX(EPSYLD, y_l(3,4))
          nameyld(ITRPA0,10) = 'SVOA'
          yieldH(ITRPA0,10) = MAX(EPSYLD, y_h(3,5))
          yieldL(ITRPA0,10) = MAX(EPSYLD, y_l(3,5))
c
c  ---- PB0B species ---
c
          numcls(ITRPB0) = 1
