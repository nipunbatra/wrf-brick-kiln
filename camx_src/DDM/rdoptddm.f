...
c
c   --- get the number of Deposition conditions species ---
c
      ndepddm =  Number_of_DEP_Species_Groups
      if( ndepddm .GT. 0 ) then
         do i = 1,ndepddm
           depddmsp(i) = Dep_Species_Groups(i)
           call toupper( depddmsp(i) )
           call jstlft( depddmsp(i) )
         enddo
      endif
c
