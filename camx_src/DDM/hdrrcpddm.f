...
c    01/08/19  --gwilson--   Revised for deposition DDM
c    04/30/19  --pkk--       Fix typo for nicddm instead of nbcddm
c
c-----------------------------------------------------------------------
c   Include files:
c-----------------------------------------------------------------------
...
c
     ...
     &                                               nspec*nbound*nbcddm
      write(iowrcp,9000,ERR=7000)
c
      write(iowrcp,9002,ERR=7000) 'Number of Deposition influencing species   ',
     &                                                            ndepddm
      write(iowrcp,9003,ERR=7000) 'Deposition influencing species             '
      if (ndepddm.gt.0)
     &        write(iowrcp,9003,ERR=7000)  (depddmsp(i),i=1,ndepddm)
c
