...
c    IO   OIO  I2O2  INO3  HIO3  IXOY   DMS   CL2    CL   ICL
c  HOCL   CLO   HCL  CLN3  CLN2  CLAO  CLAD  FMCL   BR2    BR
c   IBR  BRCL  HOBR   BRO   HBR  BRN2  BRN3  FMBR  CH3I   MI2
c   MIB   MIC   MB3   MB2   MBC  MBC2  MB2C    HI  INO2  CGLY
c   SQT
c
...
c
     ...
     &                +         r(240)+         r(253)+         r(256)
        Gain(lHO2  ) = Gain(lHO2  )
     &                +( 0.200)*r(257)+         r(261)+( 0.900)*r(262)
     &                +( 0.790)*r(273)+         r(281)+         r(303)
     &                +         r(316)+         r(318)
c
...
c
     ...
     &                +( 0.120)*r(195)+         r(254)+( 0.800)*r(257)
     &                +         r(258)+         r(259)+( 0.500)*r(260)
     &                +( 0.480)*r(263)+         r(267)+( 0.170)*r(276)
        Gain(lC2O3 ) = Gain(lC2O3 )
     &                +         r(304)
c
...
c
     ...
     &                +         r(225)+         r(226)+         r(227)
     &                +         r(228)+         r(231)+         r(232)
     &                +         r(233)+( 0.200)*r(256)+         r(259)
     &                +         r(260)+( 0.100)*r(262)+( 0.840)*r(263)
     &                +( 2.000)*r(265)+( 2.000)*r(266)+( 2.000)*r(267)
     &                +         r(268)+         r(269)+         r(270)
     &                +         r(274)+         r(275)+( 0.830)*r(276)
        Gain(lRO2  ) = Gain(lRO2  )
     &                +( 1.880)*r(277)+         r(278)+         r(279)
     &                +         r(280)+( 0.020)*r(281)+         r(282)
     &                +         r(306)+         r(307)+         r(308)
     &                +         r(309)+         r(310)
c
        Loss(lPAN  )= +         r( 55)+         r( 56)
...
c
     ...
     &                +( 0.716)*r(153)+( 0.390)*r(165)+( 0.200)*r(199)
     &                +         r(255)+( 0.500)*r(260)+         r(305)
c
...
c
     ...
     &                +( 0.500)*r(260)+( 0.950)*r(262)+( 0.991)*r(270)
     &                +( 0.170)*r(276)+         r(307)
c
...
c
     ...
     &                +( 0.500)*r(260)+( 0.100)*r(262)+( 0.320)*r(263)
     &                +         r(266)+( 0.991)*r(270)+         r(274)
     &                +( 0.920)*r(275)+( 0.730)*r(276)+( 0.880)*r(277)
     &                +( 0.700)*r(278)+( 0.900)*r(279)+( 0.900)*r(280)
        Gain(lXO2H ) = Gain(lXO2H )
     &                +         r(306)+( 0.920)*r(307)+( 0.900)*r(308)
     &                +( 0.880)*r(309)+( 0.700)*r(310)
c
...
c
     ...
     &                +         r(227)+( 0.040)*r(263)+( 0.009)*r(270)
     &                +( 0.080)*r(275)+( 0.100)*r(276)+( 0.120)*r(277)
     &                +( 0.300)*r(278)+( 0.100)*r(279)+( 0.100)*r(280)
     &                +( 0.020)*r(281)+( 0.080)*r(307)+( 0.100)*r(308)
        Gain(lXO2N ) = Gain(lXO2N )
     &                +( 0.120)*r(309)+( 0.300)*r(310)
c
...
c
     ...
     &                +( 0.142)*r(153)+( 0.267)*r(163)+( 0.530)*r(166)
...
c
     ...
     &                +         r(205)+         r(253)+( 1.800)*r(256)
     &                +         r(258)+( 0.320)*r(263)+         r(264)
     &                +         r(265)+( 1.320)*r(273)+         r(303)
     &                +         r(311)+         r(316)+         r(317)
     &                +         r(318)
c
...
c
     ...
     &                +( 0.268)*r(226)+( 0.126)*r(228)+( 0.180)*r(275)
     &                +( 0.230)*r(276)+( 0.500)*r(308)
c
...
c
     ...
     &                +( 1.400)*r(195)+( 0.500)*r(199)+( 0.500)*r(205)
        Gain(lGLY  ) = Gain(lGLY  )
     &                +( 0.200)*r(257)+( 0.210)*r(273)+( 0.025)*r(281)
c
...
c
        Gain(lBENZ )= 0.0
c
        Loss(lCRES )= +         r(182)+         r(183)+         r(281)
c
        Gain(lCRES )= +( 0.530)*r(167)+( 0.180)*r(172)+( 0.155)*r(177)
     &                +         r(185)+( 0.900)*r(279)+( 0.900)*r(280)
c
...
c
     ...
     &                +         r(188)+( 0.250)*r(192)+( 0.025)*r(281)
c
        Loss(lTOL  )= +         r(172)+         r(279)
c
        Gain(lTOL  )= 0.0
c
...
c
        Gain(lCAT1 )= +( 0.732)*r(182)+( 0.732)*r(281)
c
...
c
        Loss(lCL2  )= +         r(235)
c
        Gain(lCL2  )= +( 0.300)*r(241)
c
        Loss(lCL   )= +         r(238)+         r(239)+         r(240)
     &                +         r(253)+         r(254)+         r(255)
     &                +         r(256)+         r(257)+         r(258)
     &                +         r(259)+         r(260)+         r(261)
     &                +         r(262)+         r(263)+         r(268)
     ...
     &                +         r(281)+         r(282)
c
        Gain(lCL   )= +( 2.000)*r(235)+         r(236)+         r(237)
     &                +( 1.400)*r(241)+         r(242)+         r(245)
     &                +         r(249)+         r(250)+         r(265)
     &                +( 0.210)*r(273)+         r(285)+         r(295)
     &                +         r(315)
c
        Loss(lICL  )= +         r(236)
c
...
c
        Loss(lHOCL )= +         r(237)
c
        Gain(lHOCL )= +         r(243)+         r(244)+         r(252)
c
        Loss(lCLO  )= +( 2.000)*r(241)+         r(242)+         r(243)
     &                +         r(244)+         r(245)+         r(246)
     &                +         r(295)
c
        Gain(lCLO  )= +         r(238)+( 0.220)*r(239)+         r(247)
     &                +         r(248)
c
        Loss(lHCL  )= +         r(251)
c
        Gain(lHCL  )= +( 0.780)*r(239)+         r(240)+         r(253)
     &                +         r(254)+         r(255)+         r(256)
     &                +         r(257)+         r(258)+         r(259)
     &                +         r(260)+         r(261)+( 0.170)*r(263)
     &                +         r(264)+         r(268)+         r(269)
     &                +         r(270)+         r(271)+         r(272)
     &                +( 0.530)*r(273)+( 0.200)*r(275)+( 0.440)*r(276)
     &                +( 0.150)*r(277)+( 0.550)*r(278)+         r(279)
     &                +         r(280)+         r(281)+         r(282)
c
        Loss(lCLN3 )= +         r(247)+         r(248)+         r(249)
     &                +         r(252)
c
        Gain(lCLN3 )= +         r(246)
c
...
c
        Loss(lCLAO )= +         r(267)
c
        Gain(lCLAO )= +( 0.340)*r(263)+( 0.500)*r(275)+( 0.560)*r(276)
     &                +( 0.220)*r(277)+( 0.150)*r(278)
c
        Loss(lCLAD )= +         r(265)+         r(266)
c
        Gain(lCLAD )= +( 0.500)*r(263)+         r(274)+( 0.300)*r(275)
     &                +( 0.580)*r(277)+( 0.150)*r(278)
c
        Loss(lFMCL )= +         r(264)
c
        Gain(lFMCL )= +         r(266)+         r(267)+( 0.260)*r(273)
     &                +( 0.050)*r(277)+( 0.150)*r(278)
c
        Loss(lBR2  )= +         r(283)+         r(291)
c
        Gain(lBR2  )= +( 0.150)*r(294)+         r(327)
c
        Loss(lBR   )= +         r(287)+         r(288)+         r(289)
     &                +         r(290)+         r(303)+         r(304)
     &                +         r(305)+         r(306)+         r(307)
     &                +         r(308)+         r(309)+         r(310)
     &                +         r(327)
c
        Gain(lBR   )= +( 2.000)*r(283)+         r(284)+         r(285)
     &                +         r(286)+         r(291)+         r(292)
     &                +         r(293)+( 1.700)*r(294)+         r(295)
     &                +         r(296)+         r(298)+         r(300)
     &                +( 0.850)*r(301)+         r(314)+( 3.000)*r(316)
     &                +( 3.000)*r(317)+( 2.000)*r(318)+         r(319)
     &                +         r(320)+         r(321)
c
        Loss(lIBR  )= +         r(284)
c
...
c
        Loss(lHOBR )= +         r(286)
c
        Gain(lHOBR )= +         r(291)+         r(297)+         r(302)
c
        Loss(lBRO  )= +         r(293)+( 2.000)*r(294)+         r(295)
     &                +         r(296)+         r(297)+         r(298)
     &                +         r(299)
c
        Gain(lBRO  )= +         r(287)+         r(290)+( 0.150)*r(301)
c
        Loss(lHBR  )= +         r(292)
c
        Gain(lHBR  )= +         r(288)+         r(303)+         r(304)
     &                +         r(305)+         r(311)
c
        Loss(lBRN2 )= +         r(300)+         r(327)
c
        Gain(lBRN2 )= +         r(289)
c
        Loss(lBRN3 )= +         r(301)+         r(302)
c
        Gain(lBRN3 )= +         r(299)
c
        Loss(lFMBR )= +         r(311)
c
        Gain(lFMBR )= +         r(306)+         r(307)+         r(308)
     &                +         r(309)+         r(310)
c
        Loss(lCH3I )= +         r(312)
c
...
c
        Gain(lHI   )= +         r(322)
c
        Loss(lINO2 )= +         r(325)+( 2.000)*r(326)
c
        Gain(lINO2 )= +         r(324)
c
        Loss(lCGLY )= 0.0
c
        Gain(lCGLY )= +         r(328)+         r(329)
c
        Loss(lSQT  )= +         r(330)+         r(331)+         r(332)
c
        Gain(lSQT  )= 0.0
c
c
