...
c
     ...
     &                      +(-0.500)*rk(205)    *y(lOH)
          JAC(lNO2 ,lI   )= +         rk(324)    *y(lNO2)
          JAC(lNO2 ,lIO  )= +(-1.000)*rk(215)    *y(lNO)
     &                      +         rk(216)    *y(lNO2)
          JAC(lNO2 ,lOIO )= +(-1.000)*rk(220)    *y(lNO)
          JAC(lNO2 ,lCLO )= +(-1.000)*rk(245)    *y(lNO)
     &                      +         rk(246)    *y(lNO2)
          JAC(lNO2 ,lCLN3)= +(-1.000)*rk(247)*flg
     &                      +(-1.000)*rk(248)*flg
          JAC(lNO2 ,lCLN2)= +(-1.000)*rk(250)*flg
          JAC(lNO2 ,lBR  )= +         rk(289)    *y(lNO2)
     &                      +(-1.000)*rk(290)    *y(lNO3)
     &                      +(-1.000)*rk(327)    *y(lBRN2)
          JAC(lNO2 ,lBRO )= +(-1.000)*rk(298)    *y(lNO)
     &                      +         rk(299)    *y(lNO2)
          JAC(lNO2 ,lBRN2)= +(-1.000)*rk(300)*flg
     &                      +(-1.000)*rk(327)    *y(lBR)
          JAC(lNO2 ,lBRN3)= +(-0.150)*rk(301)*flg
          JAC(lNO2 ,lINO2)= +(-1.000)*rk(325)*flg
     &                      +(-4.000)*rk(326)    *y(lINO2)
     ...
     &                      +(-1.000)*rk( 68)    *y(lNO)
          ...
          JAC(lNO  ,lCLO )= +         rk(245)    *y(lNO)
          JAC(lNO  ,lBRO )= +         rk(298)    *y(lNO)
     ...
     &                      +(-0.130)*rk(202)    *y(lOPO3)
          ...
          JAC(lO3  ,lCL  )= +         rk(238)    *y(lO3)
          JAC(lO3  ,lBR  )= +         rk(287)    *y(lO3)
          JAC(lO3  ,lSQT )= +         rk(331)    *y(lO3)
     &                      +(-1.000)*rk(331)    *y(lO3)
     ...
     &                      +(-1.000)*rk( 38)*flg
          ...
          JAC(lNO3 ,lCLN3)= +(-1.000)*rk(249)*flg
          JAC(lNO3 ,lBR  )= +         rk(290)    *y(lNO3)
          JAC(lNO3 ,lBRN3)= +(-0.850)*rk(301)*flg
          JAC(lNO3 ,lSQT )= +         rk(332)    *y(lNO3)
     &                      +(-1.000)*rk(332)    *y(lNO3)
     ...
     &                      +         rk(232)    *y(lOH)*O2
          JAC(lOH  ,lCL  )= +(-0.220)*rk(239)    *y(lHO2)
          JAC(lOH  ,lHOCL)= +(-1.000)*rk(237)*flg
          JAC(lOH  ,lCLAO)= +         rk(267)    *y(lOH)
          JAC(lOH  ,lCLAD)= +         rk(266)    *y(lOH)
          JAC(lOH  ,lBR2 )= +         rk(291)    *y(lOH)
          JAC(lOH  ,lHOBR)= +(-1.000)*rk(286)*flg
          JAC(lOH  ,lHBR )= +         rk(292)    *y(lOH)
          JAC(lOH  ,lMB3 )= +         rk(317)    *y(lOH)
          JAC(lOH  ,lMB2 )= +         rk(318)    *y(lOH)
          JAC(lOH  ,lMBC )= +         rk(319)    *y(lOH)
          JAC(lOH  ,lMBC2)= +         rk(320)    *y(lOH)
          JAC(lOH  ,lMB2C)= +         rk(321)    *y(lOH)
          JAC(lOH  ,lHI  )= +         rk(323)    *y(lOH)
          JAC(lOH  ,lSQT )= +         rk(330)    *y(lOH)
     &                      +(-1.000)*rk(330)    *y(lOH)
     ...
     &                      +(-1.000)*rk(181)    *y(lRO2)
          ...
          JAC(lHO2 ,lI   )= +         rk(322)    *y(lHO2)
          JAC(lHO2 ,lIO  )= +         rk(214)    *y(lHO2)
          JAC(lHO2 ,lCL  )= +         rk(239)    *y(lHO2)
     &                      +(-1.000)*rk(240)*flg*H2
     &                      +(-1.000)*rk(253)    *y(lFORM)
     &                      +(-1.000)*rk(256)    *y(lGLY)
     &                      +(-0.200)*rk(257)    *y(lGLYD)
     &                      +(-1.000)*rk(261)    *y(lMEOH)
     &                      +(-0.900)*rk(262)    *y(lETOH)
     &                      +(-0.790)*rk(273)    *y(lETHY)
     &                      +(-1.000)*rk(281)    *y(lCRES)
          JAC(lHO2 ,lCLO )= +         rk(243)    *y(lHO2)
          JAC(lHO2 ,lBR  )= +         rk(288)    *y(lHO2)
     &                      +(-1.000)*rk(303)    *y(lFORM)
          JAC(lHO2 ,lBRO )= +         rk(297)    *y(lHO2)
          JAC(lHO2 ,lMB3 )= +(-1.000)*rk(316)*flg
          JAC(lHO2 ,lMB2 )= +(-1.000)*rk(318)    *y(lOH)
     ...
     &                      +         rk( 47)*flg
          ...
          JAC(lHNO3,lISPD)= +(-0.716)*rk(153)    *y(lNO3)
          ...
          JAC(lHNO3,lHCL )= +(-1.000)*rk(251)    *y(lN2O5)
          JAC(lHNO3,lCLN3)= +(-1.000)*rk(252)*flg*H2O
          JAC(lHNO3,lBRN3)= +(-1.000)*rk(302)*flg*H2O
     ...
     &                      +(-1.000)*rk(233)    *y(lNO3)
     &                      +(-1.000)*rk(282)    *y(lCL)
          JAC(lSO2 ,lCL  )= +(-1.000)*rk(282)    *y(lDMS)
     ...
     &                      +(-1.000)*rk(127)    *y(lOH)
     &                      +(-1.000)*rk(259)    *y(lCL)
          JAC(lC2O3,lIOLE)= +(-0.170)*rk(276)    *y(lCL)
     ...
     &                      +(-0.600)*rk(191)    *y(lO3)
          ...
          JAC(lC2O3,lCL  )= +(-1.000)*rk(254)    *y(lALD2)
     &                      +(-0.800)*rk(257)    *y(lGLYD)
     &                      +(-1.000)*rk(258)    *y(lMGLY)
     &                      +(-1.000)*rk(259)    *y(lACET)
     &                      +(-0.500)*rk(260)    *y(lKET)
     &                      +(-0.480)*rk(263)    *y(lISPD)
     &                      +(-0.170)*rk(276)    *y(lIOLE)
          JAC(lC2O3,lCLAO)= +(-1.000)*rk(267)    *y(lOH)
          JAC(lC2O3,lBR  )= +(-1.000)*rk(304)    *y(lALD2)
     ...
     &                      +(-1.000)*rk(232)    *y(lDMS)*O2
     &                      +(-1.000)*rk(319)    *y(lMBC)
     &                      +(-1.000)*rk(320)    *y(lMBC2)
          JAC(lMEO2,lOH  )=JAC(lMEO2,lOH  )
     &                      +(-1.000)*rk(321)    *y(lMB2C)
     ...
     &                      +(-1.000)*rk(233)    *y(lNO3)
     &                      +(-1.000)*rk(282)    *y(lCL)
          JAC(lMEO2,lCL  )= +(-0.500)*rk(260)    *y(lKET)
     &                      +(-1.000)*rk(268)*flg*CH4
     &                      +(-1.000)*rk(269)    *y(lECH4)
     &                      +(-1.000)*rk(282)    *y(lDMS)
          JAC(lMEO2,lCLO )= +         rk(244)    *y(lMEO2)
          JAC(lMEO2,lCLAD)= +(-1.000)*rk(265)*flg
          JAC(lMEO2,lCH3I)= +(-1.000)*rk(312)*flg
          JAC(lMEO2,lMBC )= +(-1.000)*rk(319)    *y(lOH)
          JAC(lMEO2,lMBC2)= +(-1.000)*rk(320)    *y(lOH)
          JAC(lMEO2,lMB2C)= +(-1.000)*rk(321)    *y(lOH)
     ...
     &                      +(-1.000)*rk(231)    *y(lDMS)
          JAC(lRO2 ,lOH  )=JAC(lRO2 ,lOH  )
     &                      +(-1.000)*rk(232)    *y(lDMS)*O2
     &                      +(-2.000)*rk(266)    *y(lCLAD)
     &                      +(-2.000)*rk(267)    *y(lCLAO)
     ...
     &                      +(-1.000)*rk(269)    *y(lCL)
          JAC(lRO2 ,lDMS )= +(-1.000)*rk(231)    *y(lOH)
     &                      +(-1.000)*rk(232)    *y(lOH)*O2
     &                      +(-1.000)*rk(233)    *y(lNO3)
     &                      +(-1.000)*rk(282)    *y(lCL)
          JAC(lRO2 ,lCL  )= +(-0.200)*rk(256)    *y(lGLY)
     &                      +(-1.000)*rk(259)    *y(lACET)
     &                      +(-1.000)*rk(260)    *y(lKET)
     &                      +(-0.100)*rk(262)    *y(lETOH)
     &                      +(-0.840)*rk(263)    *y(lISPD)
     &                      +(-1.000)*rk(268)*flg*CH4
     &                      +(-1.000)*rk(269)    *y(lECH4)
     &                      +(-1.000)*rk(270)    *y(lETHA)
     &                      +(-1.000)*rk(274)    *y(lETH)
          JAC(lRO2 ,lCL  )=JAC(lRO2 ,lCL  )
     &                      +(-1.000)*rk(275)    *y(lOLE)
     &                      +(-0.830)*rk(276)    *y(lIOLE)
     &                      +(-1.880)*rk(277)    *y(lISOP)
     &                      +(-1.000)*rk(278)    *y(lTERP)
     &                      +(-1.000)*rk(279)    *y(lTOL)
     &                      +(-1.000)*rk(280)    *y(lXYL)
     &                      +(-0.020)*rk(281)    *y(lCRES)
     &                      +(-1.000)*rk(282)    *y(lDMS)
          JAC(lRO2 ,lCLAO)= +(-2.000)*rk(267)    *y(lOH)
          JAC(lRO2 ,lCLAD)= +(-2.000)*rk(265)*flg
     &                      +(-2.000)*rk(266)    *y(lOH)
          JAC(lRO2 ,lBR  )= +(-1.000)*rk(306)    *y(lETH)
     &                      +(-1.000)*rk(307)    *y(lOLE)
     &                      +(-1.000)*rk(308)    *y(lIOLE)
     &                      +(-1.000)*rk(309)    *y(lISOP)
     &                      +(-1.000)*rk(310)    *y(lTERP)
     ...
     &                      +(-0.500)*rk(260)    *y(lCL)
          ...
          JAC(lCXO3,lISPD)= +(-0.716)*rk(153)    *y(lNO3)
          JAC(lCXO3,lOPO3)= +(-0.200)*rk(199)    *y(lNO)
          JAC(lCXO3,lTERP)= +(-0.390)*rk(165)    *y(lO3)
          JAC(lCXO3,lCL  )= +(-1.000)*rk(255)    *y(lALDX)
     &                      +(-0.500)*rk(260)    *y(lKET)
          JAC(lCXO3,lBR  )= +(-1.000)*rk(305)    *y(lALDX)
     ...
     &                      +(-0.170)*rk(276)    *y(lCL)
          ...
          JAC(lALD2,lCL  )= +         rk(254)    *y(lALD2)
     &                      +(-0.500)*rk(260)    *y(lKET)
     &                      +(-0.950)*rk(262)    *y(lETOH)
     &                      +(-0.991)*rk(270)    *y(lETHA)
     &                      +(-0.170)*rk(276)    *y(lIOLE)
          JAC(lALD2,lBR  )= +         rk(304)    *y(lALD2)
     &                      +(-1.000)*rk(307)    *y(lOLE)
     ...
     &                      +(-0.900)*rk(280)    *y(lCL)
          JAC(lXO2H,lCL  )= +(-0.500)*rk(260)    *y(lKET)
     &                      +(-0.100)*rk(262)    *y(lETOH)
     &                      +(-0.320)*rk(263)    *y(lISPD)
     &                      +(-0.991)*rk(270)    *y(lETHA)
     &                      +(-1.000)*rk(274)    *y(lETH)
     &                      +(-0.920)*rk(275)    *y(lOLE)
     &                      +(-0.730)*rk(276)    *y(lIOLE)
     &                      +(-0.880)*rk(277)    *y(lISOP)
     &                      +(-0.700)*rk(278)    *y(lTERP)
          JAC(lXO2H,lCL  )=JAC(lXO2H,lCL  )
     &                      +(-0.900)*rk(279)    *y(lTOL)
     &                      +(-0.900)*rk(280)    *y(lXYL)
          JAC(lXO2H,lCLAD)= +(-1.000)*rk(266)    *y(lOH)
          JAC(lXO2H,lBR  )= +(-1.000)*rk(306)    *y(lETH)
     &                      +(-0.920)*rk(307)    *y(lOLE)
     &                      +(-0.900)*rk(308)    *y(lIOLE)
     &                      +(-0.880)*rk(309)    *y(lISOP)
     &                      +(-0.700)*rk(310)    *y(lTERP)
     ...
     &                      +(-1.000)*rk(233)    *y(lNO3)
     &                      +(-1.000)*rk(282)    *y(lCL)
          JAC(lFORM,lCL  )= +         rk(253)    *y(lFORM)
     &                      +(-1.000)*rk(259)    *y(lACET)
     &                      +(-1.000)*rk(261)    *y(lMEOH)
     &                      +(-0.078)*rk(262)    *y(lETOH)
     &                      +(-0.100)*rk(277)    *y(lISOP)
     &                      +(-1.000)*rk(282)    *y(lDMS)
          JAC(lFORM,lBR  )= +         rk(303)    *y(lFORM)
     &                      +(-1.000)*rk(306)    *y(lETH)
          JAC(lFORM,lMI2 )= +(-1.000)*rk(313)*flg
          JAC(lFORM,lMIB )= +(-1.000)*rk(314)*flg
          JAC(lFORM,lMIC )= +(-1.000)*rk(315)*flg
     ...
     &                      +(-0.750)*rk(166)    *y(lNO3)
          ...
          JAC(lXO2 ,lCL  )= +(-0.200)*rk(256)    *y(lGLY)
     &                      +(-1.000)*rk(259)    *y(lACET)
     &                      +(-0.480)*rk(263)    *y(lISPD)
     &                      +(-0.880)*rk(277)    *y(lISOP)
          JAC(lXO2 ,lCLAO)= +(-1.000)*rk(267)    *y(lOH)
          JAC(lXO2 ,lCLAD)= +(-1.000)*rk(265)*flg
     &                      +(-1.000)*rk(266)    *y(lOH)
     ...
     &                      +(-0.100)*rk(183)    *y(lNO3)
     &                      +(-0.020)*rk(281)    *y(lCL)
          JAC(lXO2N,lTOL )= +(-0.100)*rk(279)    *y(lCL)
          JAC(lXO2N,lXOPN)= +(-0.100)*rk(192)    *y(lNO3)
          JAC(lXO2N,lXYL )= +(-0.100)*rk(280)    *y(lCL)
          JAC(lXO2N,lCL  )= +(-0.040)*rk(263)    *y(lISPD)
     &                      +(-0.009)*rk(270)    *y(lETHA)
     &                      +(-0.080)*rk(275)    *y(lOLE)
     &                      +(-0.100)*rk(276)    *y(lIOLE)
     &                      +(-0.120)*rk(277)    *y(lISOP)
     &                      +(-0.300)*rk(278)    *y(lTERP)
     &                      +(-0.100)*rk(279)    *y(lTOL)
     &                      +(-0.100)*rk(280)    *y(lXYL)
     &                      +(-0.020)*rk(281)    *y(lCRES)
          JAC(lXO2N,lBR  )= +(-0.080)*rk(307)    *y(lOLE)
     &                      +(-0.100)*rk(308)    *y(lIOLE)
     &                      +(-0.120)*rk(309)    *y(lISOP)
     &                      +(-0.300)*rk(310)    *y(lTERP)
     ...
     &                      +(-0.500)*rk(205)    *y(lOPAN)
          ...
          JAC(lNTR2,lINTR)= +(-0.267)*rk(163)    *y(lOH)
     ...
     &                      +(-0.500)*rk(191)    *y(lO3)
          ...
          JAC(lCO  ,lCL  )= +(-1.000)*rk(253)    *y(lFORM)
     &                      +(-1.800)*rk(256)    *y(lGLY)
     &                      +(-1.000)*rk(258)    *y(lMGLY)
     &                      +(-0.320)*rk(263)    *y(lISPD)
     &                      +(-1.320)*rk(273)    *y(lETHY)
          JAC(lCO  ,lCLAD)= +(-1.000)*rk(265)*flg
          JAC(lCO  ,lFMCL)= +(-1.000)*rk(264)*flg
          JAC(lCO  ,lBR  )= +(-1.000)*rk(303)    *y(lFORM)
          JAC(lCO  ,lFMBR)= +(-1.000)*rk(311)*flg
          JAC(lCO  ,lMB3 )= +(-1.000)*rk(316)*flg
     &                      +(-1.000)*rk(317)    *y(lOH)
          JAC(lCO  ,lMB2 )= +(-1.000)*rk(318)    *y(lOH)
     ...
     &                      +(-0.210)*rk(165)    *y(lO3)
     &                      +(-0.470)*rk(166)    *y(lNO3)
          JAC(lALDX,lCL  )= +         rk(255)    *y(lALDX)
     &                      +(-0.180)*rk(275)    *y(lOLE)
     &                      +(-0.230)*rk(276)    *y(lIOLE)
          JAC(lALDX,lBR  )= +         rk(305)    *y(lALDX)
     &                      +(-0.500)*rk(308)    *y(lIOLE)
     ...
     &                      +(-0.275)*rk(162)    *y(lRO2)
          JAC(lGLYD,lCL  )= +         rk(257)    *y(lGLYD)
     &                      +(-0.011)*rk(262)    *y(lETOH)
     ...
     &                      +(-0.260)*rk(181)    *y(lRO2)
          ...
          JAC(lGLY ,lCL  )= +         rk(256)    *y(lGLY)
     &                      +(-0.200)*rk(257)    *y(lGLYD)
     &                      +(-0.210)*rk(273)    *y(lETHY)
     &                      +(-0.025)*rk(281)    *y(lCRES)
     ...
     &                      +(-7.000)*rk(165)    *y(lO3)
          JAC(lPAR ,lCL  )= +( 2.500)*rk(260)    *y(lKET)
     &                      +         rk(272)    *y(lPAR)
     &                      +         rk(275)    *y(lOLE)
          JAC(lPAR ,lBR  )= +         rk(307)    *y(lOLE)
     ...
     &                      +         rk(274)    *y(lCL)
     &                      +         rk(306)    *y(lBR)
          JAC(lETH ,lCL  )= +         rk(274)    *y(lETH)
          JAC(lETH ,lBR  )= +         rk(306)    *y(lETH)
     ...
     &                      +         rk(307)    *y(lBR)
          ...
          JAC(lOLE ,lCL  )= +         rk(275)    *y(lOLE)
          JAC(lOLE ,lBR  )= +         rk(307)    *y(lOLE)
     ...
     &                      +         rk(308)    *y(lBR)
          ...
          JAC(lIOLE,lCL  )= +         rk(276)    *y(lIOLE)
          JAC(lIOLE,lBR  )= +         rk(308)    *y(lIOLE)
     ...
     &                      +         rk(277)    *y(lCL)
     &                      +         rk(309)    *y(lBR)
          JAC(lISOP,lCL  )= +         rk(277)    *y(lISOP)
          JAC(lISOP,lBR  )= +         rk(309)    *y(lISOP)
     ...
     &                      +(-1.000)*rk(157)    *y(lNO3)
          JAC(lISPD,lCL  )= +         rk(263)    *y(lISPD)
     &                      +(-0.150)*rk(277)    *y(lISOP)
          JAC(lISPD,lBR  )= +(-1.000)*rk(309)    *y(lISOP)
     ...
     &                      +(-1.000)*rk(196)    *y(lNO3)
          ...
          JAC(lOPO3,lCL  )= +(-0.170)*rk(263)    *y(lISPD)
     ...
     &                      +         rk(278)    *y(lCL)
     &                      +         rk(310)    *y(lBR)
          JAC(lTERP,lCL  )= +         rk(278)    *y(lTERP)
          JAC(lTERP,lBR  )= +         rk(310)    *y(lTERP)
     ...
     &                      +(-0.900)*rk(280)    *y(lCL)
          ...
          JAC(lCRES,lCL  )= +(-0.900)*rk(279)    *y(lTOL)
     &                      +(-0.900)*rk(280)    *y(lXYL)
     &                      +         rk(281)    *y(lCRES)
     ...
     &                      +(-0.350)*rk(181)    *y(lRO2)
          ...
          JAC(lOPEN,lCL  )= +(-0.025)*rk(281)    *y(lCRES)
          JAC(lTOL ,lOH  )= +         rk(172)    *y(lTOL)
          JAC(lTOL ,lTOL )= +         rk(172)    *y(lOH)
     &                      +         rk(279)    *y(lCL)
          JAC(lTOL ,lCL  )= +         rk(279)    *y(lTOL)
     ...
     &                      +(-0.500)*rk(187)    *y(lNO3)
          JAC(lCRO ,lCL  )= +(-0.200)*rk(281)    *y(lCRES)
     ...
     &                      +         rk(198)    *y(lNO3)
          JAC(lCAT1,lCL  )= +(-0.732)*rk(281)    *y(lCRES)
     ...
     &                      +         rk(269)    *y(lCL)
          JAC(lECH4,lCL  )= +         rk(269)    *y(lECH4)
          JAC(lI2  ,lI2  )= +         rk(209)*flg
          JAC(lI2  ,lINO2)= +(-2.000)*rk(326)    *y(lINO2)
          JAC(lI   ,lNO2 )= +         rk(324)    *y(lI)
          JAC(lI   ,lNO  )= +(-1.000)*rk(215)    *y(lIO)
          JAC(lI   ,lO3  )= +         rk(211)    *y(lI)
          JAC(lI   ,lOH  )= +(-1.000)*rk(323)    *y(lHI)
          JAC(lI   ,lHO2 )= +         rk(322)    *y(lI)
     ...
     &                      +(-1.000)*rk(296)    *y(lBRO)
          ...
          JAC(lI   ,lICL )= +(-1.000)*rk(236)*flg
          JAC(lI   ,lCLO )= +(-1.000)*rk(242)    *y(lIO)
          JAC(lI   ,lIBR )= +(-1.000)*rk(284)*flg
          JAC(lI   ,lBRO )= +(-1.000)*rk(296)    *y(lIO)
          JAC(lI   ,lCH3I)= +(-1.000)*rk(312)*flg
          JAC(lI   ,lMI2 )= +(-2.000)*rk(313)*flg
          JAC(lI   ,lMIB )= +(-1.000)*rk(314)*flg
          JAC(lI   ,lMIC )= +(-1.000)*rk(315)*flg
          JAC(lI   ,lHI  )= +(-1.000)*rk(323)    *y(lOH)
          JAC(lI   ,lINO2)= +(-1.000)*rk(325)*flg
     ...
     &                      +(-1.000)*rk(220)    *y(lNO)
          JAC(lIO  ,lCLO )= +         rk(242)    *y(lIO)
          JAC(lIO  ,lBRO )= +         rk(296)    *y(lIO)
     ...
     &                      +         rk(233)    *y(lNO3)
     &                      +         rk(282)    *y(lCL)
          JAC(lDMS ,lCL  )= +         rk(282)    *y(lDMS)
          JAC(lCL2 ,lCL2 )= +         rk(235)*flg
          JAC(lCL2 ,lCLO )= +(-0.600)*rk(241)    *y(lCLO)
          JAC(lCL  ,lNO  )= +(-1.000)*rk(245)    *y(lCLO)
          JAC(lCL  ,lO3  )= +         rk(238)    *y(lCL)
          JAC(lCL  ,lHO2 )= +         rk(239)    *y(lCL)
          JAC(lCL  ,lALD2)= +         rk(254)    *y(lCL)
          JAC(lCL  ,lFORM)= +         rk(253)    *y(lCL)
          JAC(lCL  ,lMEOH)= +         rk(261)    *y(lCL)
          JAC(lCL  ,lALDX)= +         rk(255)    *y(lCL)
          JAC(lCL  ,lGLYD)= +         rk(257)    *y(lCL)
          JAC(lCL  ,lGLY )= +         rk(256)    *y(lCL)
          JAC(lCL  ,lMGLY)= +         rk(258)    *y(lCL)
          JAC(lCL  ,lETHA)= +         rk(270)    *y(lCL)
          JAC(lCL  ,lETOH)= +         rk(262)    *y(lCL)
          JAC(lCL  ,lKET )= +         rk(260)    *y(lCL)
          JAC(lCL  ,lPAR )= +         rk(272)    *y(lCL)
          JAC(lCL  ,lACET)= +         rk(259)    *y(lCL)
          JAC(lCL  ,lPRPA)= +         rk(271)    *y(lCL)
          JAC(lCL  ,lETHY)= +         rk(273)    *y(lCL)
     &                      +(-0.210)*rk(273)    *y(lCL)
          JAC(lCL  ,lETH )= +         rk(274)    *y(lCL)
          JAC(lCL  ,lOLE )= +         rk(275)    *y(lCL)
          JAC(lCL  ,lIOLE)= +         rk(276)    *y(lCL)
          JAC(lCL  ,lISOP)= +         rk(277)    *y(lCL)
          JAC(lCL  ,lISPD)= +         rk(263)    *y(lCL)
          JAC(lCL  ,lTERP)= +         rk(278)    *y(lCL)
          JAC(lCL  ,lCRES)= +         rk(281)    *y(lCL)
          JAC(lCL  ,lTOL )= +         rk(279)    *y(lCL)
          JAC(lCL  ,lXYL )= +         rk(280)    *y(lCL)
          JAC(lCL  ,lECH4)= +         rk(269)    *y(lCL)
          JAC(lCL  ,lIO  )= +(-1.000)*rk(242)    *y(lCLO)
          JAC(lCL  ,lDMS )= +         rk(282)    *y(lCL)
          JAC(lCL  ,lCL2 )= +(-2.000)*rk(235)*flg
          JAC(lCL  ,lCL  )= +         rk(238)    *y(lO3)
     &                      +         rk(239)    *y(lHO2)
     &                      +         rk(240)*flg*H2
     &                      +         rk(253)    *y(lFORM)
     &                      +         rk(254)    *y(lALD2)
     ...
     &                      +         rk(281)    *y(lCRES)
     &                      +         rk(282)    *y(lDMS)
          JAC(lCL  ,lICL )= +(-1.000)*rk(236)*flg
          JAC(lCL  ,lHOCL)= +(-1.000)*rk(237)*flg
          JAC(lCL  ,lCLO )= +(-2.800)*rk(241)    *y(lCLO)
     &                      +(-1.000)*rk(242)    *y(lIO)
     &                      +(-1.000)*rk(245)    *y(lNO)
     &                      +(-1.000)*rk(295)    *y(lBRO)
          JAC(lCL  ,lCLN3)= +(-1.000)*rk(249)*flg
          JAC(lCL  ,lCLN2)= +(-1.000)*rk(250)*flg
          JAC(lCL  ,lCLAD)= +(-1.000)*rk(265)*flg
          JAC(lCL  ,lBRCL)= +(-1.000)*rk(285)*flg
          JAC(lCL  ,lBRO )= +(-1.000)*rk(295)    *y(lCLO)
          JAC(lCL  ,lMIC )= +(-1.000)*rk(315)*flg
          JAC(lICL ,lICL )= +         rk(236)*flg
          JAC(lHOCL,lHO2 )= +(-1.000)*rk(243)    *y(lCLO)
          JAC(lHOCL,lMEO2)= +(-1.000)*rk(244)    *y(lCLO)
          JAC(lHOCL,lHOCL)= +         rk(237)*flg
          JAC(lHOCL,lCLO )= +(-1.000)*rk(243)    *y(lHO2)
     &                      +(-1.000)*rk(244)    *y(lMEO2)
          JAC(lHOCL,lCLN3)= +(-1.000)*rk(252)*flg*H2O
          JAC(lCLO ,lNO2 )= +         rk(246)    *y(lCLO)
          JAC(lCLO ,lNO  )= +         rk(245)    *y(lCLO)
          JAC(lCLO ,lO3  )= +(-1.000)*rk(238)    *y(lCL)
          JAC(lCLO ,lHO2 )= +(-0.220)*rk(239)    *y(lCL)
     &                      +         rk(243)    *y(lCLO)
          JAC(lCLO ,lMEO2)= +         rk(244)    *y(lCLO)
          JAC(lCLO ,lIO  )= +         rk(242)    *y(lCLO)
          JAC(lCLO ,lCL  )= +(-1.000)*rk(238)    *y(lO3)
     &                      +(-0.220)*rk(239)    *y(lHO2)
          JAC(lCLO ,lCLO )= +( 4.000)*rk(241)    *y(lCLO)
     &                      +         rk(242)    *y(lIO)
     &                      +         rk(243)    *y(lHO2)
     &                      +         rk(244)    *y(lMEO2)
     &                      +         rk(245)    *y(lNO)
     &                      +         rk(246)    *y(lNO2)
     &                      +         rk(295)    *y(lBRO)
          JAC(lCLO ,lCLN3)= +(-1.000)*rk(247)*flg
     &                      +(-1.000)*rk(248)*flg
          JAC(lCLO ,lBRO )= +         rk(295)    *y(lCLO)
          JAC(lHCL ,lHO2 )= +(-0.780)*rk(239)    *y(lCL)
          JAC(lHCL ,lN2O5)= +         rk(251)    *y(lHCL)
          JAC(lHCL ,lALD2)= +(-1.000)*rk(254)    *y(lCL)
          JAC(lHCL ,lFORM)= +(-1.000)*rk(253)    *y(lCL)
          JAC(lHCL ,lMEOH)= +(-1.000)*rk(261)    *y(lCL)
          JAC(lHCL ,lALDX)= +(-1.000)*rk(255)    *y(lCL)
          JAC(lHCL ,lGLYD)= +(-1.000)*rk(257)    *y(lCL)
          JAC(lHCL ,lGLY )= +(-1.000)*rk(256)    *y(lCL)
          JAC(lHCL ,lMGLY)= +(-1.000)*rk(258)    *y(lCL)
          JAC(lHCL ,lETHA)= +(-1.000)*rk(270)    *y(lCL)
          JAC(lHCL ,lKET )= +(-1.000)*rk(260)    *y(lCL)
          JAC(lHCL ,lPAR )= +(-1.000)*rk(272)    *y(lCL)
          JAC(lHCL ,lACET)= +(-1.000)*rk(259)    *y(lCL)
          JAC(lHCL ,lPRPA)= +(-1.000)*rk(271)    *y(lCL)
          JAC(lHCL ,lETHY)= +(-0.530)*rk(273)    *y(lCL)
          JAC(lHCL ,lOLE )= +(-0.200)*rk(275)    *y(lCL)
          JAC(lHCL ,lIOLE)= +(-0.440)*rk(276)    *y(lCL)
          JAC(lHCL ,lISOP)= +(-0.150)*rk(277)    *y(lCL)
          JAC(lHCL ,lISPD)= +(-0.170)*rk(263)    *y(lCL)
          JAC(lHCL ,lTERP)= +(-0.550)*rk(278)    *y(lCL)
          JAC(lHCL ,lCRES)= +(-1.000)*rk(281)    *y(lCL)
          JAC(lHCL ,lTOL )= +(-1.000)*rk(279)    *y(lCL)
          JAC(lHCL ,lXYL )= +(-1.000)*rk(280)    *y(lCL)
          JAC(lHCL ,lECH4)= +(-1.000)*rk(269)    *y(lCL)
          JAC(lHCL ,lDMS )= +(-1.000)*rk(282)    *y(lCL)
          JAC(lHCL ,lCL  )= +(-0.780)*rk(239)    *y(lHO2)
     &                      +(-1.000)*rk(240)*flg*H2
     &                      +(-1.000)*rk(253)    *y(lFORM)
     &                      +(-1.000)*rk(254)    *y(lALD2)
     &                      +(-1.000)*rk(255)    *y(lALDX)
     &                      +(-1.000)*rk(256)    *y(lGLY)
     &                      +(-1.000)*rk(257)    *y(lGLYD)
     &                      +(-1.000)*rk(258)    *y(lMGLY)
     &                      +(-1.000)*rk(259)    *y(lACET)
          JAC(lHCL ,lCL  )=JAC(lHCL ,lCL  )
     &                      +(-1.000)*rk(260)    *y(lKET)
     &                      +(-1.000)*rk(261)    *y(lMEOH)
     &                      +(-0.170)*rk(263)    *y(lISPD)
     &                      +(-1.000)*rk(268)*flg*CH4
     &                      +(-1.000)*rk(269)    *y(lECH4)
     &                      +(-1.000)*rk(270)    *y(lETHA)
     &                      +(-1.000)*rk(271)    *y(lPRPA)
     &                      +(-1.000)*rk(272)    *y(lPAR)
          JAC(lHCL ,lCL  )=JAC(lHCL ,lCL  )
     &                      +(-0.530)*rk(273)    *y(lETHY)
     &                      +(-0.200)*rk(275)    *y(lOLE)
     &                      +(-0.440)*rk(276)    *y(lIOLE)
     &                      +(-0.150)*rk(277)    *y(lISOP)
     &                      +(-0.550)*rk(278)    *y(lTERP)
     &                      +(-1.000)*rk(279)    *y(lTOL)
     &                      +(-1.000)*rk(280)    *y(lXYL)
     &                      +(-1.000)*rk(281)    *y(lCRES)
          JAC(lHCL ,lCL  )=JAC(lHCL ,lCL  )
     &                      +(-1.000)*rk(282)    *y(lDMS)
          JAC(lHCL ,lHCL )= +         rk(251)    *y(lN2O5)
          JAC(lHCL ,lFMCL)= +(-1.000)*rk(264)*flg
          JAC(lCLN3,lNO2 )= +(-1.000)*rk(246)    *y(lCLO)
          JAC(lCLN3,lCLO )= +(-1.000)*rk(246)    *y(lNO2)
          JAC(lCLN3,lCLN3)= +         rk(247)*flg
     &                      +         rk(248)*flg
     &                      +         rk(249)*flg
     &                      +         rk(252)*flg*H2O
          JAC(lCLN2,lN2O5)= +(-1.000)*rk(251)    *y(lHCL)
          JAC(lCLN2,lHCL )= +(-1.000)*rk(251)    *y(lN2O5)
          JAC(lCLN2,lCLN2)= +         rk(250)*flg
          JAC(lCLAO,lOH  )= +         rk(267)    *y(lCLAO)
          JAC(lCLAO,lOLE )= +(-0.500)*rk(275)    *y(lCL)
          JAC(lCLAO,lIOLE)= +(-0.560)*rk(276)    *y(lCL)
          JAC(lCLAO,lISOP)= +(-0.220)*rk(277)    *y(lCL)
          JAC(lCLAO,lISPD)= +(-0.340)*rk(263)    *y(lCL)
          JAC(lCLAO,lTERP)= +(-0.150)*rk(278)    *y(lCL)
          JAC(lCLAO,lCL  )= +(-0.340)*rk(263)    *y(lISPD)
     &                      +(-0.500)*rk(275)    *y(lOLE)
     &                      +(-0.560)*rk(276)    *y(lIOLE)
     &                      +(-0.220)*rk(277)    *y(lISOP)
     &                      +(-0.150)*rk(278)    *y(lTERP)
          JAC(lCLAO,lCLAO)= +         rk(267)    *y(lOH)
          JAC(lCLAD,lOH  )= +         rk(266)    *y(lCLAD)
          JAC(lCLAD,lETH )= +(-1.000)*rk(274)    *y(lCL)
          JAC(lCLAD,lOLE )= +(-0.300)*rk(275)    *y(lCL)
          JAC(lCLAD,lISOP)= +(-0.580)*rk(277)    *y(lCL)
          JAC(lCLAD,lISPD)= +(-0.500)*rk(263)    *y(lCL)
          JAC(lCLAD,lTERP)= +(-0.150)*rk(278)    *y(lCL)
          JAC(lCLAD,lCL  )= +(-0.500)*rk(263)    *y(lISPD)
     &                      +(-1.000)*rk(274)    *y(lETH)
     &                      +(-0.300)*rk(275)    *y(lOLE)
     &                      +(-0.580)*rk(277)    *y(lISOP)
     &                      +(-0.150)*rk(278)    *y(lTERP)
          JAC(lCLAD,lCLAD)= +         rk(265)*flg
     &                      +         rk(266)    *y(lOH)
          JAC(lFMCL,lOH  )= +(-1.000)*rk(266)    *y(lCLAD)
     &                      +(-1.000)*rk(267)    *y(lCLAO)
          JAC(lFMCL,lETHY)= +(-0.260)*rk(273)    *y(lCL)
          JAC(lFMCL,lISOP)= +(-0.050)*rk(277)    *y(lCL)
          JAC(lFMCL,lTERP)= +(-0.150)*rk(278)    *y(lCL)
          JAC(lFMCL,lCL  )= +(-0.260)*rk(273)    *y(lETHY)
     &                      +(-0.050)*rk(277)    *y(lISOP)
     &                      +(-0.150)*rk(278)    *y(lTERP)
          JAC(lFMCL,lCLAO)= +(-1.000)*rk(267)    *y(lOH)
          JAC(lFMCL,lCLAD)= +(-1.000)*rk(266)    *y(lOH)
          JAC(lFMCL,lFMCL)= +         rk(264)*flg
          JAC(lBR2 ,lOH  )= +         rk(291)    *y(lBR2)
          JAC(lBR2 ,lBR2 )= +         rk(283)*flg
     &                      +         rk(291)    *y(lOH)
          JAC(lBR2 ,lBR  )= +(-1.000)*rk(327)    *y(lBRN2)
          JAC(lBR2 ,lBRO )= +(-0.300)*rk(294)    *y(lBRO)
          JAC(lBR2 ,lBRN2)= +(-1.000)*rk(327)    *y(lBR)
          JAC(lBR  ,lNO2 )= +         rk(289)    *y(lBR)
          JAC(lBR  ,lNO  )= +(-1.000)*rk(298)    *y(lBRO)
          JAC(lBR  ,lO3  )= +         rk(287)    *y(lBR)
          JAC(lBR  ,lNO3 )= +         rk(290)    *y(lBR)
          JAC(lBR  ,lOH  )= +(-1.000)*rk(291)    *y(lBR2)
     &                      +(-1.000)*rk(292)    *y(lHBR)
     &                      +(-3.000)*rk(317)    *y(lMB3)
     &                      +(-2.000)*rk(318)    *y(lMB2)
     &                      +(-1.000)*rk(319)    *y(lMBC)
     &                      +(-1.000)*rk(320)    *y(lMBC2)
     &                      +(-1.000)*rk(321)    *y(lMB2C)
          JAC(lBR  ,lHO2 )= +         rk(288)    *y(lBR)
          JAC(lBR  ,lALD2)= +         rk(304)    *y(lBR)
          JAC(lBR  ,lFORM)= +         rk(303)    *y(lBR)
          JAC(lBR  ,lALDX)= +         rk(305)    *y(lBR)
          JAC(lBR  ,lETH )= +         rk(306)    *y(lBR)
          JAC(lBR  ,lOLE )= +         rk(307)    *y(lBR)
          JAC(lBR  ,lIOLE)= +         rk(308)    *y(lBR)
          JAC(lBR  ,lISOP)= +         rk(309)    *y(lBR)
          JAC(lBR  ,lTERP)= +         rk(310)    *y(lBR)
          JAC(lBR  ,lIO  )= +(-1.000)*rk(296)    *y(lBRO)
          JAC(lBR  ,lCLO )= +(-1.000)*rk(295)    *y(lBRO)
          JAC(lBR  ,lBR2 )= +(-2.000)*rk(283)*flg
     &                      +(-1.000)*rk(291)    *y(lOH)
          JAC(lBR  ,lBR  )= +         rk(287)    *y(lO3)
     &                      +         rk(288)    *y(lHO2)
     &                      +         rk(289)    *y(lNO2)
     &                      +         rk(290)    *y(lNO3)
     &                      +         rk(303)    *y(lFORM)
     ...
     &                      +         rk(306)    *y(lETH)
     &                      +         rk(307)    *y(lOLE)
          JAC(lBR  ,lBR  )=JAC(lBR  ,lBR  )
     &                      +         rk(308)    *y(lIOLE)
     &                      +         rk(309)    *y(lISOP)
     &                      +         rk(310)    *y(lTERP)
     &                      +         rk(327)    *y(lBRN2)
          JAC(lBR  ,lIBR )= +(-1.000)*rk(284)*flg
          JAC(lBR  ,lBRCL)= +(-1.000)*rk(285)*flg
          JAC(lBR  ,lHOBR)= +(-1.000)*rk(286)*flg
          JAC(lBR  ,lBRO )= +(-1.000)*rk(293)*flg
     &                      +(-3.400)*rk(294)    *y(lBRO)
     &                      +(-1.000)*rk(295)    *y(lCLO)
     &                      +(-1.000)*rk(296)    *y(lIO)
     &                      +(-1.000)*rk(298)    *y(lNO)
          JAC(lBR  ,lHBR )= +(-1.000)*rk(292)    *y(lOH)
          JAC(lBR  ,lBRN2)= +(-1.000)*rk(300)*flg
     &                      +         rk(327)    *y(lBR)
          JAC(lBR  ,lBRN3)= +(-0.850)*rk(301)*flg
          JAC(lBR  ,lMIB )= +(-1.000)*rk(314)*flg
          JAC(lBR  ,lMB3 )= +(-3.000)*rk(316)*flg
     &                      +(-3.000)*rk(317)    *y(lOH)
          JAC(lBR  ,lMB2 )= +(-2.000)*rk(318)    *y(lOH)
          JAC(lBR  ,lMBC )= +(-1.000)*rk(319)    *y(lOH)
          JAC(lBR  ,lMBC2)= +(-1.000)*rk(320)    *y(lOH)
          JAC(lBR  ,lMB2C)= +(-1.000)*rk(321)    *y(lOH)
          JAC(lIBR ,lIBR )= +         rk(284)*flg
          JAC(lBRCL,lBRCL)= +         rk(285)*flg
          JAC(lHOBR,lOH  )= +(-1.000)*rk(291)    *y(lBR2)
          JAC(lHOBR,lHO2 )= +(-1.000)*rk(297)    *y(lBRO)
          JAC(lHOBR,lBR2 )= +(-1.000)*rk(291)    *y(lOH)
          JAC(lHOBR,lHOBR)= +         rk(286)*flg
          JAC(lHOBR,lBRO )= +(-1.000)*rk(297)    *y(lHO2)
          JAC(lHOBR,lBRN3)= +(-1.000)*rk(302)*flg*H2O
          JAC(lBRO ,lNO2 )= +         rk(299)    *y(lBRO)
          JAC(lBRO ,lNO  )= +         rk(298)    *y(lBRO)
          JAC(lBRO ,lO3  )= +(-1.000)*rk(287)    *y(lBR)
          JAC(lBRO ,lNO3 )= +(-1.000)*rk(290)    *y(lBR)
          JAC(lBRO ,lHO2 )= +         rk(297)    *y(lBRO)
          JAC(lBRO ,lIO  )= +         rk(296)    *y(lBRO)
          JAC(lBRO ,lCLO )= +         rk(295)    *y(lBRO)
          JAC(lBRO ,lBR  )= +(-1.000)*rk(287)    *y(lO3)
     &                      +(-1.000)*rk(290)    *y(lNO3)
          JAC(lBRO ,lBRO )= +         rk(293)*flg
     &                      +( 4.000)*rk(294)    *y(lBRO)
     &                      +         rk(295)    *y(lCLO)
     &                      +         rk(296)    *y(lIO)
     &                      +         rk(297)    *y(lHO2)
     &                      +         rk(298)    *y(lNO)
     &                      +         rk(299)    *y(lNO2)
          JAC(lBRO ,lBRN3)= +(-0.150)*rk(301)*flg
          JAC(lHBR ,lOH  )= +         rk(292)    *y(lHBR)
          JAC(lHBR ,lHO2 )= +(-1.000)*rk(288)    *y(lBR)
          JAC(lHBR ,lALD2)= +(-1.000)*rk(304)    *y(lBR)
          JAC(lHBR ,lFORM)= +(-1.000)*rk(303)    *y(lBR)
          JAC(lHBR ,lALDX)= +(-1.000)*rk(305)    *y(lBR)
          JAC(lHBR ,lBR  )= +(-1.000)*rk(288)    *y(lHO2)
     &                      +(-1.000)*rk(303)    *y(lFORM)
     &                      +(-1.000)*rk(304)    *y(lALD2)
     &                      +(-1.000)*rk(305)    *y(lALDX)
          JAC(lHBR ,lHBR )= +         rk(292)    *y(lOH)
          JAC(lHBR ,lFMBR)= +(-1.000)*rk(311)*flg
          JAC(lBRN2,lNO2 )= +(-1.000)*rk(289)    *y(lBR)
          JAC(lBRN2,lBR  )= +(-1.000)*rk(289)    *y(lNO2)
     &                      +         rk(327)    *y(lBRN2)
          JAC(lBRN2,lBRN2)= +         rk(300)*flg
     &                      +         rk(327)    *y(lBR)
          JAC(lBRN3,lNO2 )= +(-1.000)*rk(299)    *y(lBRO)
          JAC(lBRN3,lBRO )= +(-1.000)*rk(299)    *y(lNO2)
          JAC(lBRN3,lBRN3)= +         rk(301)*flg
     &                      +         rk(302)*flg*H2O
          JAC(lFMBR,lETH )= +(-1.000)*rk(306)    *y(lBR)
          JAC(lFMBR,lOLE )= +(-1.000)*rk(307)    *y(lBR)
          JAC(lFMBR,lIOLE)= +(-1.000)*rk(308)    *y(lBR)
          JAC(lFMBR,lISOP)= +(-1.000)*rk(309)    *y(lBR)
          JAC(lFMBR,lTERP)= +(-1.000)*rk(310)    *y(lBR)
          JAC(lFMBR,lBR  )= +(-1.000)*rk(306)    *y(lETH)
     &                      +(-1.000)*rk(307)    *y(lOLE)
     &                      +(-1.000)*rk(308)    *y(lIOLE)
     &                      +(-1.000)*rk(309)    *y(lISOP)
     &                      +(-1.000)*rk(310)    *y(lTERP)
          JAC(lFMBR,lFMBR)= +         rk(311)*flg
          JAC(lCH3I,lCH3I)= +         rk(312)*flg
          JAC(lMI2 ,lMI2 )= +         rk(313)*flg
          JAC(lMIB ,lMIB )= +         rk(314)*flg
          JAC(lMIC ,lMIC )= +         rk(315)*flg
          JAC(lMB3 ,lOH  )= +         rk(317)    *y(lMB3)
          JAC(lMB3 ,lMB3 )= +         rk(316)*flg
     &                      +         rk(317)    *y(lOH)
          JAC(lMB2 ,lOH  )= +         rk(318)    *y(lMB2)
          JAC(lMB2 ,lMB2 )= +         rk(318)    *y(lOH)
          JAC(lMBC ,lOH  )= +         rk(319)    *y(lMBC)
          JAC(lMBC ,lMBC )= +         rk(319)    *y(lOH)
          JAC(lMBC2,lOH  )= +         rk(320)    *y(lMBC2)
          JAC(lMBC2,lMBC2)= +         rk(320)    *y(lOH)
          JAC(lMB2C,lOH  )= +         rk(321)    *y(lMB2C)
          JAC(lMB2C,lMB2C)= +         rk(321)    *y(lOH)
          JAC(lHI  ,lOH  )= +         rk(323)    *y(lHI)
          JAC(lHI  ,lHO2 )= +(-1.000)*rk(322)    *y(lI)
          JAC(lHI  ,lI   )= +(-1.000)*rk(322)    *y(lHO2)
          JAC(lHI  ,lHI  )= +         rk(323)    *y(lOH)
          JAC(lINO2,lNO2 )= +(-1.000)*rk(324)    *y(lI)
          JAC(lINO2,lI   )= +(-1.000)*rk(324)    *y(lNO2)
          JAC(lINO2,lINO2)= +         rk(325)*flg
     &                      +( 4.000)*rk(326)    *y(lINO2)
          JAC(lCGLY,lGLY )= +(-1.000)*rk(328)*flg
          JAC(lCGLY,lMGLY)= +(-1.000)*rk(329)*flg
          JAC(lSQT ,lO3  )= +         rk(331)    *y(lSQT)
          JAC(lSQT ,lNO3 )= +         rk(332)    *y(lSQT)
          JAC(lSQT ,lOH  )= +         rk(330)    *y(lSQT)
          JAC(lSQT ,lSQT )= +         rk(330)    *y(lOH)
     &                      +         rk(331)    *y(lO3)
     &                      +         rk(332)    *y(lNO3)
c
      do j=1,njac
