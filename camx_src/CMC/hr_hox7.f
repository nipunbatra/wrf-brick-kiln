...
c
     ...
     &       + ( 0.500)*rk( 73)*yh(lOPO3)
     &       +          rk( 79)*yh(lMEO2)
     &       + ( 0.800)*rk( 85)*yh(lXO2H)
     &       + ( 0.900)*rk( 88)*yh(lXO2)
     &       + ( 0.900)*rk( 91)*yh(lXO2N)
     &       +          rk(150)*yh(lBZO2)
     &       +          rk(154)*yh(lTO2)
     &       +          rk(158)*yh(lXLO2)
     &       +          rk(171)*yh(lCRO)
