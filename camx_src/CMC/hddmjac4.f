...
c
     ...
     &                      +         rk(232)    *y(lOH)*O2
     &                      +         rk(233)    *y(lNO3)
          JAC(lCGLY,lGLY )= +(-1.000)*rk(234)*flg
          JAC(lCGLY,lMGLY)= +(-1.000)*rk(235)*flg
          JAC(lSQT ,lO3  )= +         rk(237)    *y(lSQT)
          JAC(lSQT ,lNO3 )= +         rk(238)    *y(lSQT)
          JAC(lSQT ,lOH  )= +         rk(236)    *y(lSQT)
          JAC(lSQT ,lSQT )= +         rk(236)    *y(lOH)
     &                      +         rk(237)    *y(lO3)
     &                      +         rk(238)    *y(lNO3)
c
      do j=1,njac
