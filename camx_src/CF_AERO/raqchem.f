     ...
     &                     idiag, iout, igrd, iaq, jaq, kaq, mwboa0)
...
c      REAL         AERWDEP( NAER ) ! aerosol wet deposition array (mm mol/liter)
      ...
      real         mwboa0          ! molecular weight of biogenic soa tracer
...
C...Also correct for molecular weight difference of oxalic acid (90.) and BOA0
      YGLY  = 0.77*90./mwboa0
      YMGLY = 0.62*90./mwboa0
      YGLYD = 0.67*90./mwboa0
