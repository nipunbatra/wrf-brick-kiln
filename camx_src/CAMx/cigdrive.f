...
c
cae$omp parallel default(shared)
cae$omp&  private(i,l,ll,n,n1,n2,ftmp,depfld1,depfld2,k,kk,ks,ke,con,area,
cae$omp&  dz,tt,pp,acig,cnc,cwtr,ph,rwtr,swtr,gwtr,aamb,cncrt,tcell,pcell,
cae$omp&  wcell,convfac,cc,cldph,cliq,tmassi,tmassf,terr,dfac,volume,vol,
cae$omp&  dtmp,dumvar,dumarr1,dumarr2,dumarr3,dumarr4,dumarr5)
cae$omp&  copyin(/ijkgrd/)
c
cae$omp do schedule(dynamic)
c
...
c
     ...
     &                           dumvar,dumvar,
     &                           dumarr1,cc,dumarr5,convfac,dtchem,dtchem,
