...
c
      ...
      call nodes_pass(is_netcdf_sm,1,MPI_LOGICAL,itag,numprocs,iproc_id)
...
c
      ...
      call nodes_pass(iksoap,NSOAPRXN,MPI_REAL,itag,numprocs,iproc_id)
c
...
c
      ...
      call nodes_pass(kacg2_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kacg1_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kbcg2_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kbcg1_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      ...
      call nodes_pass(kaoa2_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kaoa1_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kboa2_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kboa1_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kaoa0_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kboa0_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(kcrst_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(khoa_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
      ...
      call nodes_pass(luse_soap3,1,MPI_LOGICAL,itag,numprocs,iproc_id)
      call nodes_pass(luse_soap3_complx,1,MPI_LOGICAL,itag,numprocs,iproc_id)
      call nodes_pass(luse_soap3_simple,1,MPI_LOGICAL,itag,numprocs,iproc_id)
     ...
     &                                MPI_REAL,itag,numprocs,iproc_id)
      ...
      call nodes_pass(soap2_spec_names,10*NUM_SOAP_SPECIES,MPI_CHARACTER,itag,numprocs,iproc_id)
      call nodes_pass(soap3_spec_names,10*NUM_SOAP_SPECIES,MPI_CHARACTER,itag,numprocs,iproc_id)
      call nodes_pass(soap_emiss_names,10*NUM_SOAP_EMISS,MPI_CHARACTER,itag,numprocs,iproc_id)
      call nodes_pass(soap3_evap_factors,3*NUM_SOAP_EMISS,MPI_REAL,itag,numprocs,iproc_id)
c
      if( lsrfmod ) then
...
c
      call nodes_pass(idsrc,MXPTSRC*ngrid,MPI_INTEGER,itag,
     &                                               numprocs,iproc_id)
      call nodes_pass(isrc,MXPTSRC*ngrid,MPI_INTEGER,itag,
     &                                               numprocs,iproc_id)
      call nodes_pass(jsrc,MXPTSRC*ngrid,MPI_INTEGER,itag,
     &                                               numprocs,iproc_id)
c
     ...
     &                                          numprocs,iproc_id)
      do igrd=1,ngrid
        do ilay=1,nlayers_ems
          do ispc=1,soap3_ntotsp
            if (iproc_id .eq. 0) then
              CALL master_send_1species_data(saemis(ipsa3d_ems(igrd)), igrd, 
     &                               nlayers_ems, ilay, soap3_ntotsp, ispc, itag)
            else
...
c
      call nodes_pass(ptname,10*soap3_ntotsp,MPI_CHARACTER,itag,
     &                                               numprocs,iproc_id)
      call nodes_pass(ptop_fac,ntotsp,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(lsamap,soap3_ntotsp,MPI_INTEGER,itag,numprocs,iproc_id)
      call nodes_pass(lsagas,soap3_ntotsp,MPI_LOGICAL,itag,numprocs,iproc_id)
...
c
     ...
     &                                               numprocs,iproc_id)
          call nodes_pass(soap3_clsnam,3*(IDX_SOAP_POA_BB-IDX_SOAP_POA_OP+1),
     &                            MPI_CHARACTER,itag,numprocs,iproc_id)
          call nodes_pass(iptcls,MXALCLS,MPI_INTEGER,itag,
     &                                               numprocs,iproc_id)
          call nodes_pass(soap3_iptcls,IDX_SOAP_POA_BB-IDX_SOAP_POA_OP+1,
     &                              MPI_INTEGER,itag,numprocs,iproc_id)
          call nodes_pass(nptcls,MXALCLS,MPI_INTEGER,itag,
     &                                               numprocs,iproc_id)
          call nodes_pass(soap3_nptcls,IDX_SOAP_POA_BB-IDX_SOAP_POA_OP+1,
     &                              MPI_INTEGER,itag,numprocs,iproc_id)
     ...
     &                                               numprocs,iproc_id)
          call nodes_pass(soap3_iemcls,IDX_SOAP_POA_BB-IDX_SOAP_POA_OP+1,
     &                              MPI_INTEGER,itag,numprocs,iproc_id)
...
c
         call nodes_pass(ndepddm, 1,MPI_INTEGER,itag,numprocs,iproc_id)
c
