...
c
      ...
      call nodes_pass(soap3_ntotsp,1,MPI_INTEGER,itag,numprocs,iproc_id)
      ...
      call nodes_pass(soap3_ntrcls,1,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
     ...
     &                              ncol,nrow,nlay,l3davg,ncol(1),nrow(1))
